...
<body>
	...
	<div class="content">
		<div class="wrapper">
		<form id="form_867204" class="appnitro"  method="post" action="addcustomer.php">
					<div class="form_description">
			<h2>Novo cliente</h2>
			<p>Registar um novo cliente no sistema</p>
		</div>						
			<ul >
		...
		<div>
			<input id="element_1" name="element_1" class="element text large" type="text" maxlength="140" size="140" value=""/> 
		...
		<div>
			<input id="element_2" name="element_2" class="element text medium" type="text" maxlength="9" size="9" value=""/> 
		...
		<div>
			<input id="element_3" name="element_3" class="element text medium" type="text" maxlength="140" size="140" value=""/> 
		...
		</div><p class="guidelines" id="guide_4"><small>Palavra chave de acesso à área reservada</small></p> 
		</li>		<li id="li_5" >
		<label class="description" for="element_5">Representante </label>
		<div>
			<input id="element_5" name="element_5" class="element text large" type="text" maxlength="140" size="140" value=""/> 
		...
		<div>
			<input id="element_6" name="element_6" class="element text medium" type="email" maxlength="140" size="140" value=""/> 
		</div><p class="guidelines" id="guide_6"><small>Email de contacto</small></p> 
		</li>		<li id="li_7" >
		<label class="description" for="element_7">Telefone </label>
		<div>
			<input id="element_7" name="element_7" class="element text medium" type="text" maxlength="15" size="15" value=""/> 
...
<label class="choice" for="element_9_2">Inactiva</label>
					...
					<li class="buttons">
				<input id="saveForm" class="button_text" type="submit" name="submit" value="Registar">
