...
<body>
	...
	<div class="content">
		<div class="wrapper">
		<form id="form_868072" class="appnitro" enctype="multipart/form-data" method="post" action="addnews.php">
					<div class="form_description">
			<h2>Nova notícia</h2>
			<p>Adicionar nova notícia ao site</p>
		</div>						
			<ul >
		...
		<div>
			<input id="element_8" name="element_8" class="element file" type="file"/> 
				...
				<input id="saveForm" class="button_text" type="submit" name="submit" value="Inserir notícia" />
