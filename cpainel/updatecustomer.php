...
include "control.inc.php";
	...
	if ($_POST['element_4'] == ""){
		mysql_query("UPDATE customers SET company='".$company."', nif='".$nif."', username='".$username."', rep='".$rep."', email='".$email."', phone='".$phone."', state='".$state."' WHERE id='".$company_id."'"); 
	}else{
		$password = md5($_POST['element_4']);
		mysql_query("UPDATE customers SET company='".$company."', nif='".$nif."', username='".$username."', rep='".$rep."', email='".$email."', phone='".$phone."', password='".$password."', state='".$state."' WHERE id='".$company_id."'");
	}
