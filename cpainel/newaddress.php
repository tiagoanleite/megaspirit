...
<body>
	...
	<div class="content">
		<div class="wrapper">
		<form id="form_867204" class="appnitro"  method="post" action="addaddress.php">
					<div class="form_description">
			<h2>Novo endereço</h2>
			<p>Registar um novo local de entrega ao sistema para <b><? echo $company_name; ?></b></p>
		</div>						
			<ul >
...
<option value="Zimbabwe" >Zimbabwe</option>
		...
		<div>
			<textarea id="element_9" name="element_9" class="element textarea small"></textarea> 
				...
				<input id="saveForm" class="button_text" type="submit" name="submit" value="Adicionar endereço">
