<?php
	...
	mysql_query("INSERT INTO addresses(company, line1, line2, city, region, postal, country, type, notes, nick, state) VALUES('".$company_id."', '".$line1."', '".$line2."', '".$city."', '".$region."', '".$postal."', '".$country."', '1', '".$nick."', '".$notes."', '1')");
