...
<body>
	...
	<?php include "control.inc.php"; include "dependences/connection.inc.php"; include $filedir."dependences/menu.inc.php"; $address_id = $_GET['id'];
	...
	<div class="content">
		...
		<form id="form_867204" class="appnitro"  method="post" action="updateaddress.php">
			...
			<p>Alterar informações de <b><? echo $data['nick']; ?></b></p>
		</div>						
			<ul >
		...
		<div>
			<input id="element_1" name="element_1" class="element text large" type="text" maxlength="255" value="<? echo $data['nick']; ?>"/> 
		...
		<div class="right">
			...
			<option value="<? echo $data['country']; ?>" selected="selected"><? echo $data['country']; ?></option>
...
<option value="Zimbabwe" >Zimbabwe</option>
		...
		<div>
			<textarea id="element_9" name="element_9" class="element textarea small"><? echo $data['notes']; ?></textarea> 
			    ...
			    <input type="hidden" id="company_id" name="company_id" value="<? echo $company_id;?>" />
			    <input type="hidden" id="address_id" name="address_id" value="<? echo $address_id;?>" />
